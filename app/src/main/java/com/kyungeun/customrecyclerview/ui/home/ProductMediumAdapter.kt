...
class ProductMediumViewHolder(private val itemBinding: ItemProductDetailBinding, private val listener: ProductMediumAdapter.OnItemClickListener) : RecyclerView.ViewHolder(itemBinding.root),
